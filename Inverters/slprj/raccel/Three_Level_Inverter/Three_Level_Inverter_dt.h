...
( char_T * ) ( & rtB . kpvcg2livq ) , 0 , 0 , 17 } , { ( char_T * ) ( & rtB .
lkb1hwvu24 ) , 8 , 0 , 12 } , { ( char_T * ) ( & rtDW . jg01x4lfds .
LoggedData [ 0 ] ) , 11 , 0 , 10 } , { ( char_T * ) ( & rtDW . cninge1sea ) ,
8 , 0 , 6 } } ; static DataTypeTransitionTable rtBTransTable = { 4U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . TriangularWave1_rep_seq_y [ 0 ] ) , 0 , 0 , 30 } } ;
