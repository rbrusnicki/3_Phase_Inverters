...
MODEL                = Three_Level_Inverter
MODULES              = rt_logging.c Three_Level_Inverter.c Three_Level_Inverter_capi.c Three_Level_Inverter_data.c Three_Level_Inverter_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = Three_Level_Inverter.exe
MAKEFILE             = Three_Level_Inverter.mk
...
START_DIR            = C:/Users/ge62gas/Documents/MATLAB/3_Level_Inverter
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = Three_Level_Inverter_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Three_Level_Inverter \
...
rtiostream_utils.obj : $(MATLAB_ROOT)\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $(MATLAB_ROOT)\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
