...
( char_T * ) ( & rtB . iw15ldy4xv ) , 0 , 0 , 2 } , { ( char_T * ) ( & rtDW .
g3pjhgfdt3 . LoggedData ) , 11 , 0 , 1 } } ; static DataTypeTransitionTable
rtBTransTable = { 2U , rtBTransitions } ; static DataTypeTransition
rtPTransitions [ ] = { { ( char_T * ) ( & rtP . HighLevelCarrier_rep_seq_y [
0 ] ) , 0 , 0 , 5 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
