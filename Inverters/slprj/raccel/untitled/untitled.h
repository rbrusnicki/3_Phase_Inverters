...
#endif
typedef struct { real_T iw15ldy4xv ; real_T oqgz5lif2u ; } B ; typedef struct
{ struct { void * LoggedData ; } g3pjhgfdt3 ; } DW ; typedef struct {
rtwCAPI_ModelMappingInfo mmi ; } DataMapInfo ; struct P_ { real_T
HighLevelCarrier_rep_seq_y [ 2 ] ; real_T LookUpTable1_bp01Data [ 2 ] ;
