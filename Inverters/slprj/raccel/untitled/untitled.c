...
} } void MdlOutputs ( int_T tid ) { rtB . iw15ldy4xv = look1_binlxpw (
muDoubleScalarRem ( ssGetT ( rtS ) - 0.0 , rtP . Constant_Value ) , rtP .
LookUpTable1_bp01Data , rtP . HighLevelCarrier_rep_seq_y , 1U ) ; rtB .
oqgz5lif2u = 0.0 ; UNUSED_PARAMETER ( tid ) ; } void MdlOutputsTID1 ( int_T
tid ) { UNUSED_PARAMETER ( tid ) ; } void MdlUpdate ( int_T tid ) {
UNUSED_PARAMETER ( tid ) ; } void MdlUpdateTID1 ( int_T tid ) {
UNUSED_PARAMETER ( tid ) ; } void MdlTerminate ( void ) { } void
MdlInitializeSizes ( void ) { ssSetNumContStates ( rtS , 0 ) ; ssSetNumY (
rtS , 0 ) ; ssSetNumU ( rtS , 0 ) ; ssSetDirectFeedThrough ( rtS , 0 ) ;
ssSetNumSampleTimes ( rtS , 1 ) ; ssSetNumBlocks ( rtS , 9 ) ;
ssSetNumBlockIO ( rtS , 2 ) ; ssSetNumBlockParams ( rtS , 5 ) ; } void
MdlInitializeSampleTimes ( void ) { ssSetSampleTime ( rtS , 0 , 0.0 ) ;
ssSetOffsetTime ( rtS , 0 , 0.0 ) ; } void raccel_set_checksum ( ) {
ssSetChecksumVal ( rtS , 0 , 1114578795U ) ; ssSetChecksumVal ( rtS , 1 ,
1532431470U ) ; ssSetChecksumVal ( rtS , 2 , 1002958183U ) ; ssSetChecksumVal
( rtS , 3 , 3849484620U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
ssSetTFinal ( rtS , 0.01 ) ; { static RTWLogInfo rt_DataLoggingInfo ;
...
1114578795U ) ; ssSetChecksumVal ( rtS , 1 , 1532431470U ) ; ssSetChecksumVal
( rtS , 2 , 1002958183U ) ; ssSetChecksumVal ( rtS , 3 , 3849484620U ) ; {
